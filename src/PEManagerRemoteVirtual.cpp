...
bool CPEManagerRemoteVirtual::Open(PEOpenRemoteParams &params, bool use_relocs, bool readonly)
{
...
bool CPEManagerRemoteVirtual::ReloadObjectHeader()
{
	...
	_virt_size = Alignment32(GetPeakVirtualSize(), PE_DEFAULT_VIRTUAL_ALIGNMENT);
